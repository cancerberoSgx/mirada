...
test('buildTs', async t => {
  ...
  var file = buildDts({ defs: r, isOpenCv: true, debug: true, renderLocation: true, locationFilePrefix: 'https://github.com/opencv/opencv/tree/ccecd3405a22cd4ed4446574f8465fc7024f7708/modules/core/include/'}).files[0]
