...
import { fromArrayBuffer, fromFile, Mat, File } from 'mirada';
import { RunOptions, OperationExecBaseOptions, run, ScriptMat, ScriptOperation, OperationNames, ScriptContext, ImageOperation } from 'ojos';
import { RemoveProperties, asArray, serial, basename } from 'misc-utils-of-mine-generic';
