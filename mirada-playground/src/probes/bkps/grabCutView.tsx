...
//     return <div>
//       {/* <Popup content={t.description} trigger={
//         <Checkbox icon='add' toggle onChange={(e, props) => t.setActive(!!props.checked)}
//           checked={this.state.activeTools.includes(t)} label={t.name} />
//       } /> */}
//     </div>
//   }
//   introModal() {
