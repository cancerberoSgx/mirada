 ...
 * 
 * Source: [opencv2/features2d.hpp](https://github.com/opencv/opencv/tree/master/modules/core/include/opencv2/features2d.hpp#L860).
 * 
 */
export declare class DescriptorMatcher {
  ...
  /**
   *   These extended variants of [DescriptorMatcher::match](#db/d39/classcv_1_1DescriptorMatcher_1a0f046f47b68ec7074391e1e85c750cba}) methods find several best matches for each query descriptor. The matches are returned in the distance increasing order. See [DescriptorMatcher::match](#db/d39/classcv_1_1DescriptorMatcher_1a0f046f47b68ec7074391e1e85c750cba}) for the details about query and train descriptors.
   *   
