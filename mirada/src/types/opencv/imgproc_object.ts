 ...
 * templ using the specified method and stores the comparison results in result . Here are the
 * formulae for the available comparison methods ( `$I$` denotes image, `$T$` template, `$R$` result
 * ). The summation is done over template and/or the image patch: `$x' = 0...w-1, y' = 0...h-1$`
 * 
 * After the function finishes the comparison, the best matches can be found as global minimums (when
 * [TM_SQDIFF](#df/dfb/group__imgproc__object_1gga3a7850640f1fe1f58fe91a2d7583695dab65c042ed62c9e9e095a
 * 1e7e41fe2773}) was used) or maximums (when
 * [TM_CCORR](#df/dfb/group__imgproc__object_1gga3a7850640f1fe1f58fe91a2d7583695da5be00b45a4d99b5e42625
 * b4400bfde65}) or
 * [TM_CCOEFF](#df/dfb/group__imgproc__object_1gga3a7850640f1fe1f58fe91a2d7583695dac5babb7dfda59544e3e3
 * 1ea928f8cb16}) was used) using the
 * [minMaxLoc](#d2/de8/group__core__array_1gab473bf2eb6d14ff97e89b355dac20707}) function. In case of a
 * color image, template summation in the numerator and each sum in the denominator is done over all
 * of the channels and separate mean values are used for each channel. That is, the function can take
 * a color template and a color image. The result will still be a single-channel image, which is
 * easier to analyze.
 * 
