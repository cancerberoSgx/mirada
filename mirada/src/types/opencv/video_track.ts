 ...
 * @param winSize window size of optical flow algorithm. Must be not less than winSize argument of calcOpticalFlowPyrLK. It is needed to calculate required padding for pyramid levels.
 * @param maxLevel 0-based maximal pyramid level number.
 * @param withDerivatives set to precompute gradients for the every pyramid level. If pyramid is constructed without the gradients then calcOpticalFlowPyrLK will calculate them internally.
 ...
 * @param fullAffine If true, the function finds an optimal affine transformation with no additional restrictions (6 degrees of freedom). Otherwise, the class of transformations to choose from is limited to combinations of translation, rotation, and uniform scaling (4 degrees of freedom).
 */
 ...
 * 
 * [computeECC](#dc/d6b/group__video__track_1gae94247c0014ff6497a3f85e60eab0a66}), [estimateAffine2D](#d9/d0c/group__calib3d_1ga27865b1d26bac9ce91efaee83e94d4dd}), [estimateAffinePartial2D](#d9/d0c/group__calib3d_1gad767faff73e9cbd8b9d92b955b50062d}), [findHomography](#d9/d0c/group__calib3d_1ga4abc2ece9fab9398f2e560d53c8c9780})
 * 
 * @param templateImage single-channel template image; CV_8U or CV_32F array.
...
/**
 * The function readOpticalFlow loads a flow field from a file and returns it as a single matrix. Resulting [Mat](#d3/d63/classcv_1_1Mat}) has a type CV_32FC2 - floating-point, 2-channel. First channel corresponds to the flow in the horizontal direction (u), second - vertical (v).
 * 
