...
import { InputArray, int, InputOutputArray, TermCriteria, OutputArray, double, _EqPredicate } from './_types'
/*
 * # core_cluster
 *
 * TODO  
 ...
 * Mat points(count, 2, CV_32F);Mat points(count, 1, CV_32FC2);Mat points(1, count, CV_32FC2);std::vector<cv::Point2f> points(sampleCount);
