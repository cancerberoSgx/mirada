...
/**
 * This function draws matches of keypoints from two images in the output image. Match is a line connecting two keypoints (circles). See [cv::DrawMatchesFlags](#d4/d5d/group__features2d__draw_1ga2c2ede79cd5141534ae70a3fd9f324c8}).
 * 
...
/**
 * Output image matrix will be created ([Mat::create](#d3/d63/classcv_1_1Mat_1a55ced2c8d844d683ea9a725c60037ad0})), i.e. existing memory of output image may be reused. Two source image, matches and single keypoints will be drawn. For each keypoint only the center point will be drawn (without the circle around keypoint with keypoint size and orientation).
 * 
 */
export declare const DEFAULT: DrawMatchesFlags // initializer: = 0

/**
 * Output image matrix will not be created ([Mat::create](#d3/d63/classcv_1_1Mat_1a55ced2c8d844d683ea9a725c60037ad0})). Matches will be drawn on existing content of output image.
 * 
 */
