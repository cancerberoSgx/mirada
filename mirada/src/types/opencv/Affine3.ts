 ...
 * ```
 * 
 * Source: [opencv2/core/affine.hpp](https://github.com/opencv/opencv/tree/master/modules/core/include/opencv2/core/affine.hpp#L129).
 * 
 */
export declare class Affine3 {
   ...
   *   It sets the upper left 3x3 part of the matrix. The remaining part is unaffected.
   *   
   *   @param rvec 3x1 rotation vector. The direction indicates the rotation axis and its length indicates the rotation angle in radian (using the right thumb convention).
   */
   ...
   *   It sets the upper left 3x3 part of the matrix. The remaining part is unaffected.
   *   
   *   @param data 1-channel matrix. When it is a 3x3 matrix, it sets the upper left 3x3 part of the current matrix. When it is a 1x3 or 3x1 matrix, it is used as a rotation vector. The Rodrigues formula is used to compute the rotation matrix and sets the upper left 3x3 part of the current matrix.
   */
   ...
   *   
   *   Since the mapping between rotation vectors and rotation matrices is many to one, this function returns only one rotation vector that represents the current rotation matrix, which is not necessarily the same one set by `[rotation(const Vec3& rvec)](#dd/d99/classcv_1_1Affine3_1acfe7474211770799f56deb8b81d829f5})`.
   *   
   */
  public rvec(): any
