...
ReplaceColor, Threshold, WarpAffine, WarpPerspective, CvtColor, Pyr, ToRgba, Roi, Cartoonize, Wave } from '../src'
...
Threshold, WarpAffine, WarpPerspective, CvtColor, Pyr, ToRgba, Roi, Cartoonize, Wave]
