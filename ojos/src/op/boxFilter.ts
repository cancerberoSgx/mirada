...
import { OperationExecBaseOptions, WithBorderType, WithDDepth, WithKernelAnchor, WithKSize } from './types'
...
export class BoxFilter extends AbstractOperation<BoxFilterOptions> {
  ...
  optionsOrder = ['src', 'dst', 'ddepth', 'ksize', 'anchor', 'normalize', 'borderType'] as (keyof BoxFilterOptions)[]
