  ...
  if(!metadata) {
    metadata = [
      ...
      
      {
        ...
        optionsOrder: ["src","dst","type","mask","src2"],        
        options: [
          {
            name: "src",
            signature: "src: Mat",
      ...
      
      {
        ...
        sameSizeAndType: true,
        validChannels: undefined,
        optionsOrder: ["src","dst","ddepth","ksize","anchor","normalize","borderType"],        
        options: [
          {
            name: "src",
            signature: "src: Mat",
      ...
      
      {
        ...
        validChannels: undefined,
        optionsOrder: ["src","dst","threshold1","threshold2","apertureSize","L2gradient"],        
        options: [
          {
            name: "threshold1",
      ...
      
      {
        ...
        options: [
          ...
          {
            name: "edgeL2gradient",
            signature: "edgeL2gradient?: boolean",
            type: "boolean",
            typeUnion: [],
            description: "",
            optional: true
      ...
      
      {
        ...
        sameSizeAndType: true,
        validChannels: undefined,
        optionsOrder: ["src","dst","ddepth","kernel","anchor","delta","borderType"],        
        options: [
          {
            name: "src",
            signature: "src: Mat",
