...
// import { loadDataFile, Mat } from '../../src'
// import { loadMirada } from '../testUtil'

// test.before(loadMirada)

// test('faceRecognOtherModelsTest', async t => {
...
//     await loadDataFile('https://raw.githubusercontent.com/opencv/opencv/master/samples/dnn/face_detector/deploy_lowres.prototxt', 'face_detector.prototxt')
//     await loadDataFile('https://raw.githubusercontent.com/opencv/opencv_3rdparty/dnn_samples_face_detector_20180205_fp16/res10_300x300_ssd_iter_140000_fp16.caffemodel', 'face_detector.caffemodel')
//     await loadDataFile('https://raw.githubusercontent.com/pyannote/pyannote-data/master/openface.nn4.small2.v1.t7', 'face_recognition.t7')
//     // // var utils = new Utils('');
...
//     var output = document.getElementById('output')! as HTMLCanvasElement
//     var camera = document.createElement("video")! as HTMLVideoElement
...
//     document.getElementById('startStopButton')!.onclick = async function toggle() {
//       if (isRunning) {
//         isRunning = false
